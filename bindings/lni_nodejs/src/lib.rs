...
mod tests {
  fn assert_redacted(label: &str, value: &str, secret: &str) {
    assert_eq!(value, "<redacted>", "{} should return a redacted value", label);
  ...
  fn node_config_getters_redact_secret_fields() {
    ...
    assert_redacted("LndConfig.macaroon", &lnd_config.macaroon, "lnd-macaroon-secret");
    assert_redacted("LndConfig.socks5_proxy", lnd_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("ClnConfig.socks5_proxy", cln_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("PhoenixdConfig.password", &phoenixd_config.password, "phoenixd-password-secret");
    assert_redacted("PhoenixdConfig.socks5_proxy", phoenixd_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("NwcConfig.socks5_proxy", nwc_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("StrikeConfig.api_key", &strike_config.api_key, "strike-api-key-secret");
    assert_redacted("StrikeConfig.socks5_proxy", strike_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("BlinkConfig.api_key", &blink_config.api_key, "blink-api-key-secret");
    assert_redacted("BlinkConfig.socks5_proxy", blink_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("SpeedConfig.api_key", &speed_config.api_key, "speed-api-key-secret");
    assert_redacted("SpeedConfig.socks5_proxy", speed_config.socks5_proxy.as_deref().unwrap_or_default(), proxy);
    ...
    assert_redacted("SparkConfig.mnemonic", &spark_config.mnemonic, "abandon abandon abandon");
    assert_redacted("SparkConfig.passphrase", spark_config.passphrase.as_deref().unwrap_or_default(), "spark-passphrase-secret");
    assert_redacted("SparkConfig.api_key", spark_config.api_key.as_deref().unwrap_or_default(), "spark-api-key-secret");
    assert_redacted("SparkConfig.storage_dir", &spark_config.storage_dir, "/tmp/lni-spark-secret-path");
  }
}
