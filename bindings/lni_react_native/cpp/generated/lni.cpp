...
RustBuffer ffi_lni_rustbuffer_alloc(uint64_t size,
                                    RustCallStatus *uniffi_out_err);
RustBuffer ffi_lni_rustbuffer_from_bytes(ForeignBytes bytes,
                                         RustCallStatus *uniffi_out_err);
void ffi_lni_rustbuffer_free(RustBuffer buf, RustCallStatus *uniffi_out_err);
RustBuffer ffi_lni_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                      RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_lni_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_lni_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_lni_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_lni_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_lni_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_lni_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_lni_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_lni_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_lni_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_lni_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_lni_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_lni_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_lni_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_lni_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_lni_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint32_t ffi_lni_uniffi_contract_version();
}
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_lni_rustbuffer_alloc(size, &status);
  }
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf = ffi_lni_rustbuffer_from_bytes(bytes, &status);
  ...
  static jsi::Value toJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    ffi_lni_rustbuffer_free(buf, &status);
...
NativeLni::NativeLni(jsi::Runtime &rt,
  ...
  props["ffi_lni_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "ffi_lni_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_lni_uniffi_contract_version(rt, thisVal, args,
                                                             count);
          });
}
...
jsi::Value NativeLni::cpp_ffi_lni_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_lni_uniffi_contract_version();
