...
interface NativeModuleInterface {
  ...
  uniffi_lni_uniffi_fn_method_phoenixdnode_get_password(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_lni_uniffi_fn_method_phoenixdnode_get_url(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  ...
  uniffi_lni_uniffi_checksum_method_phoenixdnode_get_config(): number;
