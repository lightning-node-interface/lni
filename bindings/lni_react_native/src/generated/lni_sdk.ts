...
// Flat error type: LniSdkError
export enum LniSdkError_Tags {
  Generic = 'Generic',
}
export const LniSdkError = (() => {
  class Generic extends UniffiError {
    /**
     * @private
     * This field is private and should not be used.
     */
    readonly [uniffiTypeNameSymbol]: string = 'LniSdkError';
    /**
     * @private
     * This field is private and should not be used.
     */
    ...
    public readonly tag = LniSdkError_Tags.Generic;

    constructor(message: string) {
      super('LniSdkError', 'Generic', message);
    }
  ...
  function instanceOf(e: any): e is LniSdkError {
    return (e as any)[uniffiTypeNameSymbol] === 'LniSdkError';
  }
  return {
    Generic,
    instanceOf,
...
// Union type for LniSdkError error type.

export type LniSdkError = InstanceType<
  (typeof LniSdkError)[keyof Omit<typeof LniSdkError, 'instanceOf'>]
>;

const FfiConverterTypeLniSdkError = (() => {
  const intConverter = FfiConverterInt32;
  type TypeName = LniSdkError;
  class FfiConverter extends AbstractFfiConverterArrayBuffer<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (intConverter.read(from)) {
        case 1:
          return new LniSdkError.Generic(FfiConverterString.read(from));
