...
/*handle*/ uint64_t
uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions(void *ptr,
                                                           RustBuffer params);
...
uniffi_lni_uniffi_fn_method_phoenixdnode_make_invoice(void *ptr,
                                                      RustBuffer params);
/*handle*/ uint64_t uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer(
    void *ptr, RustBuffer offer, int64_t amount_msats, RustBuffer payer_note);
...
uint16_t uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer();
...
NativeLni::NativeLni(jsi::Runtime &rt,
  ...
  props["uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions(
                    rt, thisVal, args, count);
          });
  ...
  props["uniffi_lni_uniffi_fn_method_phoenixdnode_make_invoice"] =
      jsi::Function::createFromHostFunction(
          ...
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_lni_uniffi_fn_method_phoenixdnode_make_invoice(
                    rt, thisVal, args, count);
          });
  props["uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer"),
          4,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer(
                rt, thisVal, args, count);
          });
  ...
  props["uniffi_lni_uniffi_checksum_method_phoenixdnode_list_transactions"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "uniffi_lni_uniffi_checksum_method_"
                                        "phoenixdnode_list_transactions"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_lni_uniffi_checksum_method_phoenixdnode_list_transactions(
                    rt, thisVal, args, count);
          });
  ...
  props["uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer(
                    rt, thisVal, args, count);
          });
...
jsi::Value
NativeLni::cpp_uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_lni_uniffi_fn_method_phoenixdnode_list_transactions(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]),
      uniffi::lni::Bridging<RustBuffer>::fromJs(rt, callInvoker, args[1]));
...
jsi::Value NativeLni::cpp_uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_lni_uniffi_fn_method_phoenixdnode_pay_offer(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]),
      uniffi::lni::Bridging<RustBuffer>::fromJs(rt, callInvoker, args[1]),
...
jsi::Value
NativeLni::cpp_uniffi_lni_uniffi_checksum_method_phoenixdnode_list_transactions(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value =
      uniffi_lni_uniffi_checksum_method_phoenixdnode_list_transactions();
...
jsi::Value
NativeLni::cpp_uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_lni_uniffi_checksum_method_phoenixdnode_pay_offer();
