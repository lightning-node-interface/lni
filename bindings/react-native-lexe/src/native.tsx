...
import installer from './NativeLniLexe';
...
export * from './generated/react_native_lexe';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as react_native_lexe from './generated/react_native_lexe';
...
if (!initialized) {
  react_native_lexe.default.initialize();
  initialized = true;
}
