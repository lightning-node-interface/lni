...
pub struct LnInvoiceCreateResponse {
    ...
    pub ln_invoice_create: Option<LnInvoiceCreateResult>,
    #[serde(rename = "lnUsdInvoiceCreate")]
    pub ln_usd_invoice_create: Option<LnInvoiceCreateResult>,
}
...
pub struct LnInvoiceFeeProbeResponse {
    ...
    pub ln_invoice_fee_probe: Option<LnInvoiceFeeProbeResult>,
    #[serde(rename = "lnUsdInvoiceFeeProbe")]
    pub ln_usd_invoice_fee_probe: Option<LnInvoiceFeeProbeResult>,
}
