...
`*troubleshooting react-natve`: if you get an error, then you might need to kill the app and restart. (ios simulator - double tap home button then swipe away app)
